                ...
                <div className="navbar rounded-full p-4 bg-orange-100 shadow-lg h-20">
                    ...
                    <div className="navbar-center hidden lg:flex">
                        <ul className="menu menu-horizontal px-1 gap-4">
                            ...
                            <NavLink to="/services" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>Services</NavLink>
                            {
                                user ? <NavLink to="/my-profile" className={({ isActive }) => `rounded-full px-4 py-2 shadow font-semibold transition-colors duration-200 ${isActive ? 'bg-orange-500 text-white' : 'bg-white text-orange-500 border border-orange-500'}`}>My Profile</NavLink>
                                    : <></>
                            }
                        </ul>
                    </div>
