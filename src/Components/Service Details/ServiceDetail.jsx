...
const ServiceDetail = ({ service }) => {
    ...
    //   },
    return (
        <div className="card mt-6 w-full grid grid-cols-1 md:grid-cols-2 border-orange-500 shadow-sm-xl border-0 bg-orange-100">
            ...
            <div className="card-body border-l-2 border-orange-500 w-2/3 ">
