...
<nav className="flex flex-col items-center">
                ...
                <div className="flex gap-3 mt-3">
                    ...
                    <a href="https://www.facebook.com/Saadman.Fuad.1999/" aria-label="Sign in with Facebook" className="w-5 h-5 flex items-center justify-center rounded-full bg-white text-neutral hover:bg-gray-100 shadow">
                    ...
                    <a href="https://github.com/MD-Saadman-Fuad" aria-label="Sign in with GitHub" className="w-5 h-5 flex items-center justify-center rounded-full bg-white text-neutral hover:bg-gray-100 shadow">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
